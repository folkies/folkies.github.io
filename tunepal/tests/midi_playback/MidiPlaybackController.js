      ...
      value: function createPolyfills() {
        if (typeof navigator !== 'undefined') {
          ...
          if (typeof navigator.mediaDevices.getUserMedia === 'undefined') {
            (function () {
              var getUserMediaOld = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia;
              if (typeof getUserMediaOld !== 'undefined') {
                navigator.mediaDevices.getUserMedia = function (constraints) {
                  var callbacks = {};

                  getUserMediaOld(constraints, function (stream) {
                    return callbacks.successCallback(stream);
                  }, function (err) {
                    return callbacks.errorCallback(err);
                  });

                  return {
                    then: function then(successCallback) {
                      return callbacks.successCallback = successCallback;
                    },
                    'catch': function _catch(errorCallback) {
                      return callbacks.errorCallback = errorCallback;
                    }
                  };
                };
              }
